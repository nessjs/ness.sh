            ...
            <div className='relative pt-6 pb-16 sm:pb-24'>
              <div className='max-w-7xl mx-auto px-4 sm:px-6'>
                ...
                >
                  ...
                  <div className='p-3 bg-gray-50 md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0'>
                    <a
        ...
        --> */}
              ...
              <div className='mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6'>
                <div className='text-center'>
                  ...
                  <p className='mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl'>
                    Ness is a CLI tool for effortlessly deploying static sites to your AWS account.
                    <br />
            ...
            <div className='max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8'>
              <div>
                ...
                <p className='mt-4 text-lg text-gray-500'>
                  Ness deploys your static site with all of the best practices around security and
                  performance.
                </p>
              </div>
          ...
          <section className='py-12 bg-gray-50 overflow-hidden md:py-20 lg:py-24'>
            <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='relative'>
                <img className='mx-auto h-8' src={aws} alt='Amazon Web Services' />
